...
<div class="container pt-10 px-10" style="margin-top: -60px;">
    <div class="row" style="margin-left: 200px;">
        <h4 class="main-title p-3" style="margin-left: 40px;"><b>Edit ERT Member</b></h4>
    </div> <br>
    ...
    <section class="bg-light rounded border h-50 p-4" style="margin-left: 220px; margin-top: -20px;">
            ...
            <div class="container px-4" style="margin-top: -60px;">
                <div class="row gx-5">
                    <div class="col" style="margin-top: -25px;">
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle gx-col-md-3" type="button" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">Select Zone
                                {{-- <input type="text" name="name" id="name" class="form-control">  --}}
                                <div class="dropdown-menu">
                                    <input type="text" class="form-control" placeholder="Search Zone"
                                        id="searchInput">
                                    {{-- <div class="dropdown-divider"></div> --}}
                                    <ul class="list-unstyled" id="zoneList">
                                        <li><a class="dropdown-item" href="#" onclick="selectZone('Zone 1')">Zone
                                                1</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="selectZone('Zone 2')">Zone
                                                2</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="selectZone('Zone 3')">Zone
                                                3</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="selectZone('Zone 4')">Zone
                                                4</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="selectZone('Zone 5')">Zone
                                                5</a></li>
                                    </ul>
                                    {{-- </div></input> --}}
                            </button>
        ...
        <a href="#" class=" update-btn" style="margin-left:650px; margin-top: -100px;" title="update">
            <button class="btn btn-sm btn-primary" onclick="add_data()">Update</button>
        </a>
    </section>
</div>
